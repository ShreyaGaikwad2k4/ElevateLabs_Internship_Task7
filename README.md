...
Uses Fetch API, Promises, and async/await

Parses and renders JSON data dynamically on the page

Displays user details including name, email, and address

Handles network and API errors using .catch() and try–catch

Includes a Reload Data button to refetch and re-render the information
